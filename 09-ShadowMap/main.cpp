...
int main()
{
	...
	unsigned int cubeSpecularTex = Object3D::LoadTexture("res/textures/container_specular.png");
	...
	plane.SetTex(GL_TEXTURE1, planeTex);
	plane.SetTex(GL_TEXTURE2, depthMap);
	...
	cube.SetTex(GL_TEXTURE1, cubeSpecularTex);
	cube.SetTex(GL_TEXTURE2, depthMap);
...
// 平行光
	...
	directionLight.diffuse = glm::vec3(0.8f, 0.8f, 0.8f);
...
// 平行光
#if 0
	objectShader->setVec3("directionLight.ambient", directionLight.ambient);
	objectShader->setVec3("directionLight.diffuse", directionLight.diffuse);
	objectShader->setVec3("directionLight.direction", directionLight.direction);
	objectShader->setVec3("directionLight.specular", directionLight.specular);
#endif
